...
# 6) O(n!) Алгоритм с факториальной сложностью
# Задача коммивояжёра. Кратчайший маршрут при прохождении всех вершин.
'''
Реализация тут.
https://github.com/Clever-Shadow/python-salesman/blob/master/salesman.py

Алгоритмы с факториальной сложностью при n >= 10 работают катастрофически долго!
'''
