...
def TopologicalSort(graph):
    # Создание словаря степеней каждой вершины графа. Изначально все степени = 0
    vertexes_degrees = dict( (vertex, 0) for vertex in graph )
    '''
    Сделано с помощью генератора или цикла в 1 строчку?
    Если это генератор, то его синт. должен быть таким:
    [действия for переменной in последовательность]
    TODO: Почему не нужно ставить [] - ?
    '''
